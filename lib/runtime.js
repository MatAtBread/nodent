var defPromiseImpl = require('fs').readFileSync(__dirname+'/eager.js').toString().replace('module.exports = factory ;','') ;
var $asyncbind = eval(("(function $asyncbind(self,catcher){                                           \n"+
"   var resolver = this;                                                                              \n"+
"   if (catcher===true) {                                                                             \n"+
"       if (!Function.prototype.$asyncbind.EagerThenable)                                             \n"+
"           Function.prototype.$asyncbind.EagerThenable = ("+defPromiseImpl+")(); \n"+
