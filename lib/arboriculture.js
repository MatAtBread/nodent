    ...
    function asyncDefineMethod(ast) {
        return parser.treeWalker(ast, function (node, descend, path) {
            ...
            if (opts.promises) {
                ...
                if (!(opts.promises || opts.generators || opts.engine))
                    funcback.arguments.push(literal(opts.lazyThenables?0:true));
                transform.body = {
                    type: 'BlockStatement',
                    body: [{
                        type: 'ReturnStatement',
        ...
        parser.treeWalker(ast, function (node, descend, path) {
            ...
            if (examine(node).isAsync && examine(node).isFunction) {
                ...
                if (opts.promises) {
                    ...
                    if (!(opts.promises || opts.generators || opts.engine))
                        fnBody.arguments.push(literal(opts.lazyThenables?0:true));
                }
                fnBody = {
                    type: 'BlockStatement',
                    body: [{
