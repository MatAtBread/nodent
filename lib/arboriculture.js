    ...
    function mapLoops(node, path, down) {          
        ...
        if (!node.$mapped && examine(node).isLoop && containsAwait(node)) {
          ...
          if ('index' in ref) {
            var idx = ref.index;
            var deferredCode = ref.parent[ref.field].splice(idx + 1, ref.parent[ref.field].length - (idx + 1));
            continuation = makeContinuation(null, deferredCode) ;
          } else {
              continuation = makeContinuation(null, []) ;
          }
                          ...
                          "body": [{
                              ...
                              "consequent": {
                                  ...
                                  "argument": {
                                      ...
                                      "arguments": [ idTrampoline, genIdent.error] 
                                  }
                              },
                              "alternate": {
                                  "type":"IfStatement",
                                  ...
                                  "consequent":{
                                      type:'ReturnStatement',
                                      argument:thisCall(idExit,idCall)
                                  }
                              }
                          }]
                      }
