...
function $asyncbind(self,catcher) {
    ...
    if (!Function.prototype.$asyncbind.LazyThenable) {
        Function.prototype.$asyncbind.LazyThenable = !!!'thenable'();
    }
    if (!Function.prototype.$asyncbind.Thenable)
        Function.prototype.$asyncbind.Thenable = (Function.prototype.$asyncbind.EagerThenable = !!!'zousan')();

    var resolver = this;
    switch (catcher) {
    case true:
        return new (Function.prototype.$asyncbind.Thenable)(boundThen);
    case 0:
        return new (Function.prototype.$asyncbind.LazyThenable)(boundThen);
    case null:
        return boundThen ;
    case undefined:
