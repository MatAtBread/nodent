   ...
   */
    ...
    function mapBlock(node, path, down) {
        ...
        if (examine(ref.self).isBlockStatement && examine(ref.parent).isBlockStatement) {
            ...
            if (containsAwaitInBlock(node) && containsBlockScopedDeclarations(node.body)) {
                ...
                if ('index' in ref) {
                    ...
                    if (deferredCode.length) {
                        ...
                        ref.parent[ref.field].push(ctn);
                    } else {
//                        ref.parent[ref.field].splice(idx,1);
                    }
                } else {
